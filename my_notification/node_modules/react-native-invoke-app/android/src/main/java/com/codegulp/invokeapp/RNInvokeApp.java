...
public class RNInvokeApp extends ReactContextBaseJavaModule {
    ...
    public void invokeApp(ReadableMap params) {
        ...
        try {
            ...
            // changed "FLAG_ACTIVITY_SINGLE_TOP" to "FLAG_ACTIVITY_NEW_TASK"
            activityIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK); // activityIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
