...
public class ReactNativeEventStarter {
  ...
  public void trigger(@NonNull Bundle jobBundle) {
    ...
    if (!appInForeground || allowExecutionInForeground) {
      // Will execute if the app is in background, or in forground but it has
      // permision to do so
  ...
  public static class MyHeadlessJsTaskService extends HeadlessJsTaskService {
    ...
    public void onCreate() {
      ...
      if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
        ...
        // TODO
        // This notification appears some times, i didnt think a way to remove it, the jobbackground could deppend on it to work as expected
    ...
    private void openApp(Context context) {
      // open the app
      Intent launchIntent = context.getPackageManager().getLaunchIntentForPackage("com.my_notification");
    ...
    protected HeadlessJsTaskConfig getTaskConfig(Intent intent) {
      ...
      ReactNativeHost reactNativeHost = ((ReactApplication) getApplicationContext()).getReactNativeHost();
      boolean appInForeground = Utils.isReactNativeAppInForeground(reactNativeHost);
      if (appInForeground && !allowExecutionInForeground) {
        return null;
      }
      return new HeadlessJsTaskConfig(intent.getStringExtra("jobKey"), Arguments.fromBundle(extras), timeout,
    ...
    public static void start(Context context, Bundle jobBundle) {
      ...
      try {
        //maybe i open my app openApp()

        
      } catch (Exception e) {
        Log.d(LOG_TAG, "motivo2: " + e.toString());
      }
